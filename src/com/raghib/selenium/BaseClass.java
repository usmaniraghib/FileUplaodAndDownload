...
public class BaseClass {
	...
	public static WebDriver getDriver(String browserName, String browserVersion, Map<String, Object> mapObject) {		
		if(browserName.equalsIgnoreCase("edge")) {
			...
			chromeOptions.setExperimentalOption("prefs", mapObject);
